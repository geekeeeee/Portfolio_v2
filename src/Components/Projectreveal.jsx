...
export const Projectreveal1 = (props) => {
  return (
    <div className="grid grid-flow-col grid-cols-4 space-x-4 my-20 mx-10">
...
">
            ...
            >
                <a href={props.link} className="font-medium mb-2">{props.projectName}</a>
...
export const Projectreveal2 = (props) => {
    return (
      <div className="grid grid-flow-col grid-cols-4 space-x-4  mx-10 my-20">
